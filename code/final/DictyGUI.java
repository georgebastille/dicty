...
public class DictyGUI {
	...
	public void makeControls(){
		...
		cDecSlider = new JSlider(JSlider.VERTICAL, 0, 20, (int)(b.theta*400));
		cDecSlider.addChangeListener(new ChangeListener(){
			public void stateChanged(ChangeEvent arg0) {
				b.theta = (float) (cDecSlider.getValue()/400.0);
	...
	public void drawBufferedCells() {
		...
		for (x = 1; x < (l + 1); x++) {
			for (y = 1; y < (l + 1); y++) {
				...
				if (b.stateOf[b.s[x][y]][0] == 3) {
					bigdt.setColor(Color.yellow);
